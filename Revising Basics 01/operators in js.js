...
let firstFavNum = 31;
let secondFavNum = 7;
let isGreat = firstFavNum > secondFavNum;
let isLess = firstFavNum < secondFavNum;
let isGreatOrEquals = firstFavNum >= secondFavNum;
let isLessOrEquals = firstFavNum <= secondFavNum;
let isEqualStrict = firstFavNum === secondFavNum;
